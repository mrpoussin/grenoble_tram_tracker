...
import { Stop, StopArrivals, ProcessedArrival, TrackPoint, DIRECTION_COLORS, DIRECTION_NAMES, getArrivalColor } from '@/lib/types';
...
function ArrivalBadge({ arrival, direction }: { arrival: ProcessedArrival; direction: number }) {
  ...
  const arrivalColor = getArrivalColor(minutes);

  return (
    <div
      className="flex items-center gap-2 px-2 py-1 rounded-md"
      style={{
        background: `${arrivalColor}20`,
        borderLeft: `3px solid ${arrivalColor}`,
      }}
    >
      <span
